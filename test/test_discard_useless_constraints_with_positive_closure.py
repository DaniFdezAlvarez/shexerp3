...
_BASE_DIR = BASE_FILES + "discard_useless_positive\\"

class TestDiscardUselessConstraintsWithPositiveClosure(unittest.TestCase):
    ...
    def test_no_compilant_no_discard(self):
        ...
        self.assertTrue(file_vs_str_tunned_comparison(file_path=_BASE_DIR + "no_compilant_no_discard.shex",
    ...
    def test_compilant_no_discard(self):
        ...
        str_result = shaper.shex_graph(string_output=True)
        # print(str_result)
        self.assertTrue(file_vs_str_tunned_comparison(file_path=_BASE_DIR + "compilant_no_discard.shex",
                                                      str_target=str_result))
    ...
    def test_no_compilant_discard(self):
        ...
        str_result = shaper.shex_graph(string_output=True)
        # print(str_result)
        self.assertTrue(file_vs_str_tunned_comparison(file_path=_BASE_DIR + "no_compilant_discard.shex",
                                                      str_target=str_result))
